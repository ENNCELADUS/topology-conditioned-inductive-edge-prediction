...
**Post-review experiment status (updated 2026-07-14):** the G1 B0/PA-null arm, G2, and G3
Oracle have been run on the repository-local `breadth_first` artifacts. The current values
and the completed G1 architecture-independence closeout are recorded in
