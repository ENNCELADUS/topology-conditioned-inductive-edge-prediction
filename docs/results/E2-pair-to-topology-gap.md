...
**Status:** the G1 B0/PA-null arm and G2 are complete; the canonical G1 metric rerun
completed on 2026-07-13. The required B0-alt replication is absent (`b0_alt: null`),
so G1 is not fully closed. The synchronized artifacts use the frozen V3.1 B0 scorer, checkpoint
`e092537d8cf1e208`, and the full 2,037,171-row candidate
...
G1 B0-alt replication and G3 (Oracle) remain pending.
...
Its archived assembled metrics predate the canonical MMD-ratio evaluator and are not
quoted as current or comparable topology results. The curated package is
...
before EgoStitch implementation begins. The architecture-independence claim also remains
unresolved until B0-alt is evaluated under the same canonical metric.
...
The latest checkpoint-only rerun is preserved separately at
[`outputs/runs/legacy_v31_s47_20260712T193900Z/`](../../outputs/runs/legacy_v31_s47_20260712T193900Z/);
its classification and G2 results remain historical context, while its retired-format
assembled metrics are not reused as canonical results.
