...
10-epoch run was engineering-shortened and is not a complete
...
telemetry but do not reject a diagnostic run; diagnostic stages run to completion.
Completeness, finite state, DDP
